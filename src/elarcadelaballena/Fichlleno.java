...
public class Fichlleno {
    ...
    public void crearFavoritos(Persona recibe, String juego, String comentario) {
        if (!recibe.getNombre().equals(null)) {
            PrintWriter escribir = null;
            FileWriter nuevo = null;
            try {
                nuevo = new FileWriter(recibe.getNombre() + ".txt", true);
